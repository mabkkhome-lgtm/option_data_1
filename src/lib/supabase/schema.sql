...
-- Market Levels (Calculated Support/Resistance/Gamma)
CREATE TABLE IF NOT EXISTS market_levels (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    timestamp TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    expiry_date TEXT NOT NULL,
    current_price NUMERIC,
    gamma_high_price NUMERIC,
    gamma_low_price NUMERIC,
...
CREATE INDEX IF NOT EXISTS idx_market_levels_ts ON market_levels(timestamp DESC);
